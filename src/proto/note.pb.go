...
type GetSearchNotesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Search parameters
	SearchType GetSearchNotesRequest_SearchType `protobuf:"varint,1,opt,name=search_type,json=searchType,proto3,enum=note.GetSearchNotesRequest_SearchType" json:"search_type,omitempty"`
...
const file_src_proto_note_proto_rawDesc = "" +
	"\n" +
	"\x14src/proto/note.proto\x12\x04note\x1a\x1fgoogle/protobuf/timestamp.proto\" \n" +
	"\x0eGetNoteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"\xfa\x01\n" +
	"\x15GetSearchNotesRequest\x12G\n" +
	"\vsearch_type\x18\x01 \x01(\x0e2&.note.GetSearchNotesRequest.SearchTypeR\n" +
	"searchType\x12\x14\n" +
	...
	"\x10stripped_content\x18\x05 \x01(\tR\x0fstrippedContent\"\xdc\x01\n" +
	"\x04Note\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x14\n" +
	...
	"\tauthor_id\x18\x05 \x01(\x05R\bauthorId\x126\n" +
	"\vpermissions\x18\a \x03(\v2\x14.note.NotePermissionR\vpermissionsJ\x04\b\x06\x10\a\"C\n" +
	...
	"_author_id2\xaa\x01\n" +
	"\vNoteService\x12+\n" +
	"\aGetNote\x12\x14.note.GetNoteRequest\x1a\n" +
	".note.Note\x12-\n" +
	"\bPostNote\x12\x15.note.PostNoteRequest\x1a\n" +
	".note.Note\x12?\n" +
	"\vSearchNotes\x12\x1b.note.GetSearchNotesRequest\x1a\x11.note.MinimalNote0\x01B2Z0github.com/KuramaSyu/Wersu-Rest/src/pb/note;noteb\x06proto3"
...
var file_src_proto_note_proto_goTypes = []any{
	(GetSearchNotesRequest_SearchType)(0), // 0: note.GetSearchNotesRequest.SearchType
	(*GetNoteRequest)(nil),                // 1: note.GetNoteRequest
	(*GetSearchNotesRequest)(nil),         // 2: note.GetSearchNotesRequest
	(*MinimalNote)(nil),                   // 3: note.MinimalNote
	(*Note)(nil),                          // 4: note.Note
	(*NoteEmbedding)(nil),                 // 5: note.NoteEmbedding
	(*NotePermission)(nil),                // 6: note.NotePermission
	(*PostNoteRequest)(nil),               // 7: note.PostNoteRequest
	(*AlterNoteRequest)(nil),              // 8: note.AlterNoteRequest
	(*timestamppb.Timestamp)(nil),         // 9: google.protobuf.Timestamp
}
var file_src_proto_note_proto_depIdxs = []int32{
	0, // 0: note.GetSearchNotesRequest.search_type:type_name -> note.GetSearchNotesRequest.SearchType
	9, // 1: note.MinimalNote.updated_at:type_name -> google.protobuf.Timestamp
	9, // 2: note.Note.updated_at:type_name -> google.protobuf.Timestamp
	6, // 3: note.Note.permissions:type_name -> note.NotePermission
	1, // 4: note.NoteService.GetNote:input_type -> note.GetNoteRequest
	7, // 5: note.NoteService.PostNote:input_type -> note.PostNoteRequest
	2, // 6: note.NoteService.SearchNotes:input_type -> note.GetSearchNotesRequest
	4, // 7: note.NoteService.GetNote:output_type -> note.Note
	4, // 8: note.NoteService.PostNote:output_type -> note.Note
	3, // 9: note.NoteService.SearchNotes:output_type -> note.MinimalNote
