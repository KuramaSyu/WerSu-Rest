...
const file_src_proto_note_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04slug\x18\x02 \x01(\tR\x04slug\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\"\xe3\x02\n" +
	"\x04Note\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	...
	"\auser_id\x18\n" +
	" \x01(\tR\x06userId\x12%\n" +
	"\x0eattachment_ids\x18\v \x03(\tR\rattachmentIdsJ\x04\b\x06\x10\a\"\xb5\x01\n" +
...
var file_src_proto_note_proto_depIdxs = []int32{
	...
	0,  // 13: proto.PermissionSubject.object_type:type_name -> proto.PermissionObjectType
	0,  // 14: proto.PermissionResource.object_type:type_name -> proto.PermissionObjectType
	22, // 15: proto.PermissionRelationship.subject:type_name -> proto.PermissionSubject
	23, // 16: proto.PermissionRelationship.resource:type_name -> proto.PermissionResource
	0,  // 17: proto.GetPermissionsRequest.object_type:type_name -> proto.PermissionObjectType
	0,  // 18: proto.CreatePermissionRequest.object_type:type_name -> proto.PermissionObjectType
	24, // 19: proto.CreatePermissionRequest.relationship:type_name -> proto.PermissionRelationship
	0,  // 20: proto.DeletePermissionRequest.object_type:type_name -> proto.PermissionObjectType
	24, // 21: proto.DeletePermissionRequest.relationship:type_name -> proto.PermissionRelationship
	0,  // 22: proto.ReplacePermissionsRequest.object_type:type_name -> proto.PermissionObjectType
	24, // 23: proto.ReplacePermissionsRequest.relationships:type_name -> proto.PermissionRelationship
	0,  // 24: proto.PermissionsResponse.object_type:type_name -> proto.PermissionObjectType
	24, // 25: proto.PermissionsResponse.relationships:type_name -> proto.PermissionRelationship
	37, // 26: proto.NoteVersionSummary.created_at:type_name -> google.protobuf.Timestamp
	37, // 27: proto.NoteVersionContent.created_at:type_name -> google.protobuf.Timestamp
	2,  // 28: proto.NoteService.GetNote:input_type -> proto.GetNoteRequest
	11, // 29: proto.NoteService.PostNote:input_type -> proto.PostNoteRequest
	13, // 30: proto.NoteService.PatchNote:input_type -> proto.AlterNoteRequest
	12, // 31: proto.NoteService.DeleteNote:input_type -> proto.DeleteNoteRequest
	3,  // 32: proto.NoteService.SearchNotes:input_type -> proto.GetSearchNotesRequest
	16, // 33: proto.DirectoryService.GetDirectory:input_type -> proto.GetDirectoryRequest
	17, // 34: proto.DirectoryService.GetDirectories:input_type -> proto.GetDirectoriesRequest
	18, // 35: proto.DirectoryService.CreateDirectory:input_type -> proto.CreateDirectoryRequest
	19, // 36: proto.DirectoryService.PatchDirectory:input_type -> proto.AlterDirectoryRequest
	20, // 37: proto.DirectoryService.DeleteDirectory:input_type -> proto.DeleteDirectoryRequest
	21, // 38: proto.DirectoryService.GetNotesOfDirectory:input_type -> proto.GetNotesOfDirectoryRequest
	25, // 39: proto.PermissionService.GetPermissions:input_type -> proto.GetPermissionsRequest
	26, // 40: proto.PermissionService.CreatePermission:input_type -> proto.CreatePermissionRequest
	27, // 41: proto.PermissionService.DeletePermission:input_type -> proto.DeletePermissionRequest
	28, // 42: proto.PermissionService.ReplacePermissions:input_type -> proto.ReplacePermissionsRequest
	31, // 43: proto.NoteVersionService.GetNoteVersions:input_type -> proto.GetNoteVersionsRequest
	32, // 44: proto.NoteVersionService.GetDirectoryActivity:input_type -> proto.GetDirectoryActivityRequest
	34, // 45: proto.NoteVersionService.GetNoteVersionContent:input_type -> proto.GetNoteVersionContentRequest
	35, // 46: proto.NoteVersionService.RestoreNoteVersion:input_type -> proto.RestoreNoteVersionRequest
	9,  // 47: proto.NoteService.GetNote:output_type -> proto.NoteResponse
	8,  // 48: proto.NoteService.PostNote:output_type -> proto.Note
	8,  // 49: proto.NoteService.PatchNote:output_type -> proto.Note
	8,  // 50: proto.NoteService.DeleteNote:output_type -> proto.Note
	4,  // 51: proto.NoteService.SearchNotes:output_type -> proto.NotesReply
	15, // 52: proto.DirectoryService.GetDirectory:output_type -> proto.Directory
	15, // 53: proto.DirectoryService.GetDirectories:output_type -> proto.Directory
	15, // 54: proto.DirectoryService.CreateDirectory:output_type -> proto.Directory
	15, // 55: proto.DirectoryService.PatchDirectory:output_type -> proto.Directory
	15, // 56: proto.DirectoryService.DeleteDirectory:output_type -> proto.Directory
	4,  // 57: proto.DirectoryService.GetNotesOfDirectory:output_type -> proto.NotesReply
	29, // 58: proto.PermissionService.GetPermissions:output_type -> proto.PermissionsResponse
	29, // 59: proto.PermissionService.CreatePermission:output_type -> proto.PermissionsResponse
	29, // 60: proto.PermissionService.DeletePermission:output_type -> proto.PermissionsResponse
	29, // 61: proto.PermissionService.ReplacePermissions:output_type -> proto.PermissionsResponse
	30, // 62: proto.NoteVersionService.GetNoteVersions:output_type -> proto.NoteVersionSummary
	30, // 63: proto.NoteVersionService.GetDirectoryActivity:output_type -> proto.NoteVersionSummary
	33, // 64: proto.NoteVersionService.GetNoteVersionContent:output_type -> proto.NoteVersionContent
	8,  // 65: proto.NoteVersionService.RestoreNoteVersion:output_type -> proto.Note
