...
const (
	RuleService_CreateRule_FullMethodName = "/proto.RuleService/CreateRule"
	RuleService_GetRule_FullMethodName    = "/proto.RuleService/GetRule"
	RuleService_GetRules_FullMethodName   = "/proto.RuleService/GetRules"
	RuleService_UpdateRule_FullMethodName = "/proto.RuleService/UpdateRule"
	RuleService_DeleteRule_FullMethodName = "/proto.RuleService/DeleteRule"
)
...
func (c *ruleServiceClient) GetRules(ctx context.Context, in *GetRulesRequest, opts ...grpc.CallOption) (*GetRulesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRuleServiceServer) GetRules(context.Context, *GetRulesRequest) (*GetRulesResponse, error) {
